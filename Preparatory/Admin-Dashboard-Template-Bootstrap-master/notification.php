    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-light white scrolling-navbar">
        <div class="container-fluid">
            ...
            <a class="navbar-brand waves-effect" href="index.php" target="_blank">
                <img src="data:image/svg+xml;utf8;base64," />

                <strong class="blue-text" style="text-align: center;">فتيان المذبح
                ...
                <li class="dropdown" style="margin-left: -400px;">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            echo "<h6 style='color: darkred;margin-top: -20px;margin-left: 30px;'>".$counter."</h6>";
                        }
                        ?>
                    </a>
